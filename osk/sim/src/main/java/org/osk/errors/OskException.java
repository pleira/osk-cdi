...
public class OskException extends Exception {

    /** Serializable UID. */
    private static final long serialVersionUID = 336675798265469677L;
     ...
     * @since 5.1
     */
    public OskException(final OskException exception) {
        super(exception);
     ...
     */
    public OskException(final Localizable message, final Throwable cause) {
        super(cause);
        this.context   = null;
     ...
     * @param parts parts to insert in the format (no translation)
     */
    public OskException(final Throwable cause, final Localizable specifier,
                           final Object ... parts) {
        super(cause);
        this.context   = null;
        this.specifier = specifier;
    ...
    public static RuntimeException createInternalError(final Throwable cause) {
        ...
        /** Format specifier (to be translated). */
        final Localizable specifier = OskMessages.INTERNAL_ERROR;
