...
public class Pipe07 extends PipeT1 {
	...
	@Inject
	void initLength(@NumberConfig(name = "pipe7.length", defaultValue = "1.5") Double value) {
	setLength(value);
	}
	...
	@Inject
	void initSurfaceRoughness(@NumberConfig(name = "pipe7.surfaceRoughness", defaultValue = "0.0085") Double value) {
